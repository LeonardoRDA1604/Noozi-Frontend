...
export function DateInput({ label, id, value, tooltip, required, helpText, onChange }: DateInputProps) {
  ...
  return (
    <div>
      ...
      />
      <p className="mt-1 ml-1 text-xs text-noozi-gray-500">{helpText}</p>
    </div>
  );
}
