    ...
    extend: {
      ...
      colors: {
        noozi: {
          ...
          // Cores semânticas via CSS variables — mudam no dark mode
          default_screen: "var(--color-default-screen)", // default screen background
          input_field:    "var(--color-input-field)",
          background:     "var(--color-background)",
          surface:        "var(--color-surface)",        // fundo de cards, painéis
          border:         "var(--color-border)",
          text:           "var(--color-text)",
          muted:          "var(--color-muted)",          // texto secundário (também usado no cinza médio / gray-500)
