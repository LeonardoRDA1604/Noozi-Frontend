```markdown
## O que foi feito?
Descrição clara e objetiva das alterações realizadas.

## Por quê?
Contexto e motivação da mudança. Referência à Issue, se houver (Closes #123).
...
- [ ] Testei manualmente o fluxo que alterei
...
- [ ] O Pull Request está apontando para a branch `dev`
- [ ] Componentes novos seguem os padrões do projeto e são reutilizáveis
